namespace AutoSettingUI.Wpf.Demo.Resources;

/// <summary>
/// Provides access to localized string resources for the WPF demo application.
        ...
        get
        {
            if (_resourceManager == null)
            {
                _resourceManager = new System.Resources.ResourceManager(
                    "AutoSettingUI.Wpf.Demo.Resources.Strings",
